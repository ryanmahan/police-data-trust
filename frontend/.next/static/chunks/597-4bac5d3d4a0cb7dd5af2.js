    ...
    7599: function (t, e, r) {
      ...
      function f(t, e) {
        return l().then(function (r) {
          if (!(e in r)) throw u(new Error("Failed to lookup route: ".concat(e)))
    ...
    1689: function (t, e, r) {
        ...
        try {
          ...
          if ((0, p.isDynamicRoute)(a.pathname) && a.searchParams && r) {
            var c = (0, v.searchParamsToUrlQuery)(a.searchParams),
              ...
              l = s.result,
              f = s.params
            l && (i = (0, h.formatWithValidation)({ pathname: l, hash: a.hash, query: C(c, f) }))
          }
      ...
      function A(t, e) {
        ...
        return "/404" === r || "/_error" === r
          ...
          : (e.includes(r) ||
              e.some(function (e) {
                if ((0, p.isDynamicRoute)(e) && (0, g.getRouteRegex)(e).re.test(r))
                  return (t = e), !0
              }),
                          ...
                          switch ((e.prev = e.next)) {
                            ...
                            case 18:
                              if (
                                ...
                                (a = k(b(S(a) ? E(a) : a, i.locale, this.defaultLocale))),
                            ...
                            case 50:
                              if (
                                ...
                                (M = a),
                                "/_error" !== (P = P ? (0, u.removePathTrailingSlash)(E(P)) : P) &&
                                  ((_.pathname = A(P, j)),
                                  _.pathname !== P &&
                                    ((P = _.pathname), (o = (0, h.formatWithValidation)(_)))),
                            ...
                            case 60:
                              if (((M = x(E(M), this.locale)), !(0, p.isDynamicRoute)(D))) {
                                e.next = 76
                                break
                              }
                              if (
                            ...
                            case 80:
                              ...
                              if (
                                (((tt = (0, d.parseRelativeUrl)(Z)).pathname = A(tt.pathname, j)),
                            ...
                            case 104:
                              return (
                                (e.next = 106), this.getRouteInfo(ot, ot, O, a, M, { shallow: !1 })
                              )
                            case 106:
                              $ = e.sent
                            case 107:
                            ...
                            case 114:
                              ...
                              throw (t.events.emit("routeChangeError", X, w, y), X)
                            case 117:
                              return (
                      ...
                      function (t) {
                        for (;;)
                          switch ((t.prev = t.next)) {
                            ...
                            case 21:
                              ;(v = (0, u.removePathTrailingSlash)(i)), (t.next = 24)
                              break
                            case 24:
                              return (
                                (t.next = 26),
